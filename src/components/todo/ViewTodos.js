              ...
              {/* <td>{todo.isCompleted.toString()}</td> */}
							{
								todo.completed 
									?	<td>
											<button className="btn btn-info" disabled="disabled" onClick={() => markCompleted(todo.id)}>Completed</button>
										</td>
									:	<td>
											<button className="btn btn-warning" onClick={() => markCompleted(todo.id)}>Mark Complete</button>
										</td>
							}
